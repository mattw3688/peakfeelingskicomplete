                        ...
                        <td>
                            ...
                            if ($this->admin_image_div_callback) {
                                ...
                                <div id="headimg" style="<?php echo $header_image_style; ?>">
                                    ...
                                    ?>
                                    <h1><a id="name" class="displaying-header-text" <?php echo $style; ?>
                                           onclick="return false;" href="<?php bloginfo('url'); ?>"
                ...
                <?php if (current_theme_supports('custom-header', 'header-text')) : ?>
                    ...
                    <table class="form-table" role="presentation">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    <label><input type="checkbox" name="display-header-text"
        ...
        <div class="wrap">
            ...
            <form method="post" action="<?php echo esc_url(add_query_arg('step', 3)); ?>">
                ...
                <div id="crop_image" style="position: relative">
                    <img src="<?php echo esc_url($url); ?>" id="upload" width="<?php echo $width; ?>"
                         height="<?php echo $height; ?>" alt=""/>
                </div>
