                ...
                <table class="form-table" role="presentation">
                    ...
                    <?php if (get_background_image()) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <fieldset>
                                    <legend class="screen-reader-text"><span><?php _e('Image Size'); ?></span></legend>
                            ...
                            <td>
                                <fieldset>
                                    <legend class="screen-reader-text">
                                        <span><?php _ex('Repeat', 'Background Repeat'); ?></span></legend>
                        ...
                        <tr>
                            ...
                            <td>
                                <fieldset>
                                    <legend class="screen-reader-text">
                                        <span><?php _ex('Scroll', 'Background Scroll'); ?></span></legend>
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text"><span><?php _e('Background Color'); ?></span>
                                </legend>
                                <?php
                                $default_color = '';
