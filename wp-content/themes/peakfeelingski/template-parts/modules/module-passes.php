...
<div class="container text-center">
    <div class="form-row mt-2">
        ...
        <label for="liftpass-box"><h5>Check the box to select these lift passes and confirm you have read and accept the <a href="#" data-featherlight="#<?php echo $term_id; ?> .content">terms and conditions</a> associated with it.</h5></label>
    </div>
</div>
