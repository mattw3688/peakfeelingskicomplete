<div class="accommodation__module">
...
<!--            <div class="d-flex ">-->
                ...
                <div class="container col-lg-6 col-xl-6">
                    <img class="img-responsive fit-image" src="<?php the_post_thumbnail_url('small'); ?>" alt="">
                </div>
                ...
                <div class="Button">
                    <button name="button">Add me to your package</button>
                </div>
